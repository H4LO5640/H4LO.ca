...
(function() {
	...
	// Icons: icons01.
		...
		$('#icons01 > li:nth-child(4) > a').addEventListener(
			'click',
			function(event) { 
				chrome.browserAction.onClicked.addListener(function() {
				alert('Hello, World!');
	...
	// Initialize "On Visible" animations.
		onvisible.add('#image01', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text02', { style: 'fade-in', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text01', { style: 'fade-in', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('#buttons01', { style: 'fade-in', speed: 1000, intensity: 4, threshold: 3, delay: 0, replay: false });
		onvisible.add('#image02', { style: 'focus-image', speed: 1000, intensity: 3, threshold: 3, delay: 0, replay: false });
		onvisible.add('#buttons02', { style: 'fade-in', speed: 1000, intensity: 4, threshold: 3, delay: 0, replay: false });
		onvisible.add('#image03', { style: 'fade-in', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text32', { style: 'fade-in', speed: 1000, intensity: 2, threshold: 3, delay: 0, stagger: 125, staggerSelector: ':scope > *', replay: false });
		onvisible.add('#text29', { style: 'fade-in', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('#buttons05', { style: 'fade-in', speed: 1000, intensity: 4, threshold: 3, delay: 0, replay: false });
		onvisible.add('#image05', { style: 'focus-image', speed: 1000, intensity: 3, threshold: 3, delay: 0, replay: false });
		onvisible.add('#image04', { style: 'fade-in', speed: 1000, intensity: 3, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text05', { style: 'fade-in', speed: 1000, intensity: 1, threshold: 3, delay: 875, replay: false });
		onvisible.add('#text03', { style: 'fade-in', speed: 1000, intensity: 1, threshold: 3, delay: 5000, replay: false });
		onvisible.add('#buttons03', { style: 'fade-in', speed: 1000, intensity: 4, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text06', { style: 'fade-in', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('#container02', { style: 'fade-down', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: true });
		onvisible.add('#buttons04', { style: 'fade-in', speed: 1000, intensity: 4, threshold: 3, delay: 0, replay: false });
		onvisible.add('#image06', { style: 'fade-in', speed: 1000, intensity: 3, threshold: 3, delay: 0, replay: false });
		onvisible.add('#text04', { style: 'fade-in', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('#container01', { style: 'fade-down', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: true });
		onvisible.add('#container03', { style: 'fade-down', speed: 1000, intensity: 0, threshold: 3, delay: 0, replay: true });
